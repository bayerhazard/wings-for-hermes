...
const LOCALES = {
  en: {
    ...
    cmd_theme: 'Switch appearance (theme: system/dark/light/aimighty, skin: default/midnight)',
    ...
    composer_placeholder_idle: 'How can I help?',
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    settings_mode_advanced_desktop_only: 'Available on larger screens',
    settings_desc_ui_mode: 'Basic keeps the interface lean — just the chat, with memory and insights one tap away. Advanced unlocks every panel and tool.',
    wings_activity_thinking: 'Thinking',
    wings_activity_working: 'Working',
    wings_activity_thoughts: 'Thought process',
    wings_activity_action_one: '1 action',
    wings_activity_actions_many: '{0} actions',
    wings_activity_file_one: '1 file',
    wings_activity_files_many: '{0} files',
    wings_activity_toggle: 'Show or hide activity',
    ...
    settings_saving: 'Settings are being saved...',
  ...
  de: {
    ...
    cmd_theme: 'Darstellung wechseln (Theme: system/dark/light/aimighty, Skin: default/midnight)',
    ...
    workspace_switched_new_chat: 'Started a new chat in {0}',
    settings_desc_busy_placeholder_hint: 'Shows the composer placeholder with the current busy action while the session is running and the draft is empty.',
    composer_placeholder_idle: 'Wie kann ich helfen?',
    composer_placeholder_busy_queue: 'Enter = queue | /interrupt | /background | /steer',
    composer_placeholder_busy_interrupt: 'Enter = interrupt | /queue | /background | /steer',
    composer_placeholder_busy_steer: 'Enter = steer | /queue | /background | /interrupt',
  ...
  folder_add_as_space_title: 'Als Bereich hinzufügen?',
    ...
    settings_saving: 'Einstellungen werden gespeichert...',
    ...
    settings_mode_advanced_desktop_only: 'Auf größeren Bildschirmen verfügbar',
    settings_desc_ui_mode: 'Basic hält die Oberfläche schlank — nur der Chat, mit Memory und Statistiken einen Klick entfernt. Erweitert schaltet alle Bereiche und Werkzeuge frei.',
    wings_activity_thinking: 'Denkt nach',
    wings_activity_working: 'Arbeitet',
    wings_activity_thoughts: 'Überlegungen',
    wings_activity_action_one: '1 Aktion',
    wings_activity_actions_many: '{0} Aktionen',
    wings_activity_file_one: '1 Datei',
    wings_activity_files_many: '{0} Dateien',
    wings_activity_toggle: 'Aktivität ein- oder ausblenden',
