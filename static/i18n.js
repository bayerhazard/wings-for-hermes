...
const LOCALES = {
  en: {
    ...
    cmd_theme: 'Switch appearance (theme: system/dark/light, skin: default/midnight/neon)',
  ...
  de: {
    ...
    cmd_theme: 'Darstellung wechseln (Theme: system/dark/light, Skin: default/midnight/neon)',
