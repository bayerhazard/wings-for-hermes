...
(function(){
  ...
  syncMode();
  window.addEventListener('online',function(){syncMode();    dispatch('wings:pwa-connection-change',{online:true});});
  window.addEventListener('offline',function(){syncMode();    dispatch('wings:pwa-connection-change',{online:false});});
  ...
  window.addEventListener('beforeinstallprompt',function(event){
    ...
    window.wingsDeferredInstallPrompt=event;
    root.classList.add('pwa-installable');
    dispatch('wings:pwa-installable');
  });
  window.addEventListener('appinstalled',function(){
    window.wingsDeferredInstallPrompt=null;
    root.classList.remove('pwa-installable');
    root.classList.add('pwa-installed');
    dispatch('wings:pwa-installed');
  });
  ...
  window.WingsPWA={
    ...
    promptInstall:function(){
      var prompt=window.wingsDeferredInstallPrompt;
